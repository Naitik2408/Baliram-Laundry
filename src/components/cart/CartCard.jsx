...
function CartCard({ title, image, price, quantity, ironCloth, isIron, onIncrement, onDecrement, onToggleIron }) {
    return (
        <div className='flex items-center gap-4 py-4 border-b border-stone-300'>
            ...
            <div className='flex-1'>
                ...
                <div className='text-sm text-stone-600'>Price: {price} Rs/kg</div>
